...
const (
	HealthService_Check_FullMethodName = "/mockpay.v1.HealthService/Check"
)
...
//
// Health 提供健康检查接口。
// Issue 1 为存活级；Issue 7 接入渠道交易后保持存活级即可
// （mockpay 无数据库依赖，就绪检查不适用）。
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockpay.v1.HealthService",
	...
	Metadata: "mockpay/v1/mockpay.proto",
}
